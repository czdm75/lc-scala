...
/** Your Trie object will be instantiated and called as such: val obj = new Trie() obj.insert(word) val param_2 =
  * obj.search(word) val param_3 = obj.startsWith(prefix)
  */
